...
=======
import { globalFilter, arrayWithMovies, orderByLetterA, orderByLetterZ, orderByScoreMinus, orderByScorePlus } from '../src/data.js';
>>>>>>> a55b4e8d12fcdfc26e2482877a0b87bfac09551a
...
describe("orderByLetterA", () => {
  ...
  test("Esperamos que retorne Castle in the Sky en la posición 0", () => {
...
describe ("orderByLetterZ", () =>{
  ...
  test("Esperamos que retorne Whisper of the Heart en la ultima posición", () => {
...
describe ("orderByScoreMinus" , () => {
  ...
  test("Esperamos que retorne Tales from Earthsea", () => {
